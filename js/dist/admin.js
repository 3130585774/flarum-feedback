...
/* harmony import */ var flarum_admin_components_AdminNav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! flarum/admin/components/AdminNav */ "flarum/admin/components/AdminNav");
/* harmony import */ var flarum_admin_components_AdminNav__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(flarum_admin_components_AdminNav__WEBPACK_IMPORTED_MODULE_7__);
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().initializers.add('mcaxe-feedback', () => {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_6__.extend)((flarum_admin_components_AdminNav__WEBPACK_IMPORTED_MODULE_7___default().prototype), 'items', function (items) {
    items.add('feedback-link', m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_4___default()), {
...
class FeedbackPage extends (flarum_admin_components_AdminPage__WEBPACK_IMPORTED_MODULE_2___default()) {
  ...
  loadFeedbacks() {
    ...
    flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().request({
      method: 'GET',
      url: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('apiUrl') + `/mcaxe-flarum-feedbacks-list?page[offset]=${this.pageOffset}&page[limit]=${this.pageLimit}`
    }).then(result => {
  ...
  content() {
    ...
    }, this.loading ? m((flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_5___default()), null) : m("div", {
