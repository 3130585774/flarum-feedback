...
class FeedbackModal extends (flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_5___default()) {
  ...
  footer() {
    return m("div", {
      ...
      onclick: () => this.submit()
    }, "\u63D0\u4EA4"), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default()), {
      className: "Button",
      style: {
        flex: 1
      },
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().initializers.add('mcaxe-feedback', () => {
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_2__.extend)((flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_3___default().prototype), 'view', function (vdom) {
